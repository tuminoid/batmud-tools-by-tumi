...
<h2 id="welcome">Raceinfo by Tumi, $VERSION</h2>
...
$content .= qq|\t\t<td class="raceinfo_header"><br />Rebirth</td>\n| if (scalar param() < 2 || param('show_rebirth'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Str</td>\n| if (scalar param() < 2 || param('show_str'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Dex</td>\n| if (scalar param() < 2 || param('show_dex'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Con</td>\n| if (scalar param() < 2 || param('show_con'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Int</td>\n| if (scalar param() < 2 || param('show_int'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Wis</td>\n| if (scalar param() < 2 || param('show_wis'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Size</td>\n| if (scalar param() < 2 || param('show_siz'));
$content .= qq|\t\t<td class="raceinfo_header">Exp<br />rate</td>\n| if (scalar param() < 2 || param('show_exprate'));
$content .= qq|\t\t<td class="raceinfo_header">Skill<br />max</td>\n| if (scalar param() < 2 || param('show_skillmax'));
$content .= qq|\t\t<td class="raceinfo_header">Spell<br />max</td>\n| if (scalar param() < 2 || param('show_spellmax'));
$content .= qq|\t\t<td class="raceinfo_header">Skill<br />cost</td>\n| if (scalar param() < 2 || param('show_skillcost'));
$content .= qq|\t\t<td class="raceinfo_header">Spell<br />cost</td>\n| if (scalar param() < 2 || param('show_spellcost'));

$content .= qq|\t\t<td class="raceinfo_header">Fast<br />meta</td>\n| if (scalar param() < 2 || param('show_fm'));
$content .= qq|\t\t<td class="raceinfo_header">Infra<br />vision</td>\n| if (scalar param() < 2 || param('show_infra'));
$content .= qq|\t\t<td class="raceinfo_header">HP-<br />tick</td>\n| if (scalar param() < 2 || param('show_hptick'));
$content .= qq|\t\t<td class="raceinfo_header">SP-<br />tick</td>\n| if (scalar param() < 2 || param('show_sptick'));
$content .= qq|\t\t<td class="raceinfo_header">Eat<br />corpses</td>\n| if (scalar param() < 2 || param('show_eatcorpses'));
$content .= qq|\t\t<td class="raceinfo_header">Eat<br />food</td>\n| if (scalar param() < 2 || param('show_eatfood'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Vision</td>\n| if (scalar param() < 2 || param('show_vision'));
$content .= qq|\t\t<td class="raceinfo_header">See<br />magic</td>\n| if (scalar param() < 2 || param('show_seemagic'));
$content .= qq|\t\t<td class="raceinfo_header">See<br />invis</td>\n| if (scalar param() < 2 || param('show_seeinvis'));
$content .= qq|\t\t<td class="raceinfo_header">Escape<br />death</td>\n| if (scalar param() < 2 || param('show_escapedeath'));
$content .= qq|\t\t<td class="raceinfo_header">Water<br />allergy</td>\n| if (scalar param() < 2 || param('show_allergy'));
$content .= qq|\t\t<td class="raceinfo_header">Clair<br />voyance</td>\n| if (scalar param() < 2 || param('show_clair'));
$content .= qq|\t\t<td class="raceinfo_header">Armour<br />class</td>\n| if (scalar param() < 2 || param('show_ac'));
$content .= qq|\t\t<td class="raceinfo_header">Hp/Con<br />ratio</td>\n| if (scalar param() < 2 || param('show_hpratio'));
$content .= qq|\t\t<td class="raceinfo_header">Special<br />notes</td>\n| if (scalar param() < 2 || param('show_special'));
...
$content .= qq|\t\t<td class="raceinfo_cell">$rebirth</td>\n| if (scalar param() < 2 || param('show_rebirth'));
$content .= qq|\t\t<td class="raceinfo_cell">$str</td>\n| if (scalar param() < 2 || param('show_str'));
$content .= qq|\t\t<td class="raceinfo_cell">$dex</td>\n| if (scalar param() < 2 || param('show_dex'));
$content .= qq|\t\t<td class="raceinfo_cell">$con</td>\n| if (scalar param() < 2 || param('show_con'));
$content .= qq|\t\t<td class="raceinfo_cell">$int</td>\n| if (scalar param() < 2 || param('show_int'));
$content .= qq|\t\t<td class="raceinfo_cell">$wis</td>\n| if (scalar param() < 2 || param('show_wis'));
$content .= qq|\t\t<td class="raceinfo_cell">$size</td>\n| if (scalar param() < 2 || param('show_siz'));
$content .= qq|\t\t<td class="raceinfo_cell">$exprate</td>\n| if (scalar param() < 2 || param('show_exprate'));
$content .= qq|\t\t<td class="raceinfo_cell">$skillmax</td>\n| if (scalar param() < 2 || param('show_skillmax'));
$content .= qq|\t\t<td class="raceinfo_cell">$spellmax</td>\n| if (scalar param() < 2 || param('show_spellmax'));
$content .= qq|\t\t<td class="raceinfo_cell">$skillcost</td>\n| if (scalar param() < 2 || param('show_skillcost'));
$content .= qq|\t\t<td class="raceinfo_cell">$spellcost</td>\n| if (scalar param() < 2 || param('show_spellcost'));

$content .= qq|\t\t<td class="raceinfo_cell">$meta</td>\n| if (scalar param() < 2 || param('show_fm'));
$content .= qq|\t\t<td class="raceinfo_cell">$infra</td>\n| if (scalar param() < 2 || param('show_infra'));
$content .= qq|\t\t<td class="raceinfo_cell">$hptick</td>\n| if (scalar param() < 2 || param('show_hptick'));
$content .= qq|\t\t<td class="raceinfo_cell">$sptick</td>\n| if (scalar param() < 2 || param('show_sptick'));
$content .= qq|\t\t<td class="raceinfo_cell">$eatcorp</td>\n| if (scalar param() < 2 || param('show_eatcorpses'));
$content .= qq|\t\t<td class="raceinfo_cell">$eatfood</td>\n| if (scalar param() < 2 || param('show_eatfood'));
$content .= qq|\t\t<td class="raceinfo_cell">$vision</td>\n| if (scalar param() < 2 || param('show_vision'));
$content .= qq|\t\t<td class="raceinfo_cell">$seemagic</td>\n| if (scalar param() < 2 || param('show_seemagic'));
$content .= qq|\t\t<td class="raceinfo_cell">$seeinvis</td>\n| if (scalar param() < 2 || param('show_seeinvis'));
$content .= qq|\t\t<td class="raceinfo_cell">$escape</td>\n| if (scalar param() < 2 || param('show_escapedeath'));
$content .= qq|\t\t<td class="raceinfo_cell">$allergy</td>\n| if (scalar param() < 2 || param('show_allergy'));
$content .= qq|\t\t<td class="raceinfo_cell">$clair</td>\n| if (scalar param() < 2 || param('show_clair'));
$content .= qq|\t\t<td class="raceinfo_cell">$ac</td>\n| if (scalar param() < 2 || param('show_ac'));
$content .= qq|\t\t<td class="raceinfo_cell">$hpratio</td>\n| if (scalar param() < 2 || param('show_hpratio'));
$content .= qq|\t\t<td class="raceinfo_cell_special">$special</td>\n| if (scalar param() < 2 || param('show_special'));
...
$content .= qq|\t<tr class="raceinfo_the_header">\n|;
$content .= qq|\t\t<td class="raceinfo_header_race"><br />Race</td>\n|;
$content .= qq|\t\t<td class="raceinfo_header"><br />Rebirth</td>\n| if (scalar param() < 2 || param('show_rebirth'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Str</td>\n| if (scalar param() < 2 || param('show_str'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Dex</td>\n| if (scalar param() < 2 || param('show_dex'));
$content .= qq|\t\t<td class="raceinfo_header"><br />Con</td>\n| if (scalar param() < 2 || param('show_con'));
...
BatmudIndex::pageOutput('item400', $content, param('debug'));
